...
class AddTagViewWidget extends StatefulWidget {
...
class AddTagViewWidgetState extends State<AddTagViewWidget>
                          ...
                          if (selectedTags != null) {
                            ...
                            if (checkConnection) {
                              if (clientId != null && clientId.isNotEmpty) {
                                AddTagsToContactRequestHolder param =
                                    AddTagsToContactRequestHolder(
                                  id: clientId,
                                  data: AddTagsToContactRequestParamHolder(
                                    tags: selectedTags,
                                  ),
                                );
                                PsProgressDialog.showDialog(context);
                                Resources<EditContactResponse> response =
                                    await contactsProvider
                                        .doEditContactApiCall(param);
                                if (response.data != null &&
                                    response.data.editContactResponseData !=
                                        null &&
                                    response.data.editContactResponseData
                                            .contacts.tags !=
                                        null) {
                                ...
                                final AddContactRequestParamHolder
                                    addContactRequestParamHolder =
                                    AddContactRequestParamHolder(
                                  country: widget.countryId,
                                  name: Utils.getString("unknown"),
                                  company: "",
                                  visibility: false,
                                  phoneNumber: widget.clientNumber,
                                  email: null,
                                  address: "",
                                  tags: selectedTags,
                                );
                                PsProgressDialog.showDialog(context);
                                final Resources<AddContactResponse>
                                    addContactResponse =
                                    await contactsProvider.doAddContactsApiCall(
                                        addContactRequestParamHolder, null);
                                if (addContactResponse != null &&
                                    addContactResponse.data != null) {
                                  PsProgressDialog.dismissDialog();
                                  Navigator.of(context).pop({
                                    'data': true,
                                    'clientId': addContactResponse
                                        .data.addContactResponseData.contacts.id
                                  });
                                } else {
                                  PsProgressDialog.dismissDialog();
                            ...
                            showDialog<dynamic>(
                                ...
                                builder: (BuildContext context) {
                                  return ErrorDialog(
                                    message: Utils.getString('tagsNotFound'),
                                  );
                                });
                          }
                        },
                                    ...
                                    children: <Widget>[
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              margin: EdgeInsets.fromLTRB(
                                                  ...
                                                  Dimens.space0),
                                              child: Text(
                                                Utils.convertCamelCasing(contactsProvider
                                                                .contactDetailResponse
                                                                .data !=
                                                            null &&
                                                        contactsProvider
                                      ...
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(
                                            ...
                                            Dimens.space0.w,
                                            Dimens.space0.h),
                                        child: Text(widget.clientNumber,
                                            textAlign: TextAlign.center,
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyText2
                                                                        ...
                                                                        onColorPicked:
                                                                          ...
                                                                          AddTagRequestParamHolder
                                                                            ...
                                                                            title:
                                                                                controllerSearchTag.text,
                                                                            backgroundColorCode:
                                                                                selectedColor.backgroundColorCode,
                                                                            colorCode:
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          containerAlignment:
                                                                              Alignment.center,
                                                                          iconColor:
                                                                              HexToColor(selectedColor.colorCode),
                                                                          iconSize:
                                                                              Dimens.space20,
                                                                          boxDecorationColor:
                                                                              HexToColor(selectedColor.colorCode),
                                                              ...
                                                              showDialog<
                                                                  ...
                                                                  builder:
                                                                      (BuildContext
                                                                          context) {
                                                                    return ErrorDialog(
                                                                      message: TagsValidation.isValidTagsValidation(
                                                                          controllerSearchTag
                                                                              .text),
                                                                    );
                                                                  });
