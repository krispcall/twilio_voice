              ...
              child: Stack(
                ...
                children: [
                  RefreshIndicator(
                          ...
                          onCallTap: (clientName, clientNumber, flagUrl)
                          {
                            Utils.checkInternetConnectivity().then((value)
                            {
                              if (value)
                              {
                                ...
                                if (callLogProvider.callLogs.data[index].recentConversationNodes.blocked!=null && callLogProvider.callLogs.data[index].recentConversationNodes.blocked)
                                {
                    ...
                    onRefresh: () {
                      return callLogProvider.doCallLogsApiCall("all");
                    },
                  ),
                  Positioned(
                    bottom: 0,
                    ...
                    child: Offstage(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.fromLTRB(Dimens.space10.sp,
                            Dimens.space0, Dimens.space10.sp, Dimens.space0),
                    ...
                    child: Transform(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.fromLTRB(Dimens.space0,
                            Dimens.space0, Dimens.space0, Dimens.space70.sp),
