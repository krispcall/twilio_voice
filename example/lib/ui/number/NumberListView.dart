...
import 'package:voice_example/provider/numbers/MyNumberProviders.dart';
...
import 'package:voice_example/ui/number/NumberListItemView.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: CustomAppBar<MyNumberProvider>(
            ...
            initProvider: () {
              return MyNumberProvider(limit: 20, myNumberRepository: myNumberRepository);
            },
            onProviderReady: (MyNumberProvider provider) async {
              ...
              controllerSearchTeams.addListener(() {
                if (controllerSearchTeams.text != null &&
                  ...
                  myNumberProvider.doDbNumbersSearch(controllerSearchTeams.text);
                } else {
                  myNumberProvider.doGetMyNumbersListApiCall();
                }
              });
            ...
            builder:
                (BuildContext context, MyNumberProvider provider, Widget child) {
                    ...
                    Expanded(
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          if (provider.numbers != null &&
                              provider.numbers.data != null) {
                            if (provider.numbers.data.length > 0) {
                              return MediaQuery.removePadding(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: provider.numbers.data.length,
                                    padding: EdgeInsets.fromLTRB(
                                        Dimens.space0.w,
                                        Dimens.space20.h,
                                        Dimens.space0.w,
                                    ...
                                    itemBuilder:
                                      ...
                                      return NumberListItemView(
                                        ...
                                        number: provider.numbers.data[index],
                                        onPressed: () async {},
                                        onLongPressed: () {},
                                      );
                                    },
