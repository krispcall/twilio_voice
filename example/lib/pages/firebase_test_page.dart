...
import 'package:voice_example/common_widgets/simple_button.dart';
import 'package:voice_example/datasources/firebase_datasource.dart';
              ...
              return ListView(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(widget.firebaseAppToken, style: TextStyle(color: Colors.purple)),
                  ),
                  SimpleButton(
