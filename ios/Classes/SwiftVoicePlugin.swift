...
public class SwiftTwilioVoice: NSObject, FlutterPlugin, AVAudioPlayerDelegate {
    ...
    func reportIncomingCall(from: String, uuid: UUID, oldToken: String?) {
        ...
        let playerid =  UserDefaults.standard.string(forKey: "flutter.IOS_PLAYER_ID");


        if let retrievedValue = UserDefaults.standard.string(forKey: "flutter.IOS_PLAYER_ID") {
...
extension SwiftTwilioVoice: NotificationDelegate{
    ...
    public func callInviteReceived(callInvite: CallInvite) {
        ...
        if(isOutgoingInProgress){
            ...
            let oldtoken: String? = callInvite.customParameters?["old_token"]
            print(callInvite.customParameters);
            reportIncomingCall(from: ((contactName != nil && (contactName?.lowercased() != "null") && (contactName != nil && contactName?.lowercased() != "unknown")) ? contactName:contactNumber) ??  "",  uuid: callInvite.uuid, oldToken: oldtoken)
